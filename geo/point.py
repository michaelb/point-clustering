...
from geo.cluster import Cluster
...
class Point:
    ...
    def __init__(self, coordinates, neighbors = []):
        ...
        self.cluster = Cluster([self], count=1)
        self.quadrant = None
    ...
    def distance_carre_to(self,other):
        """
        euclidean distance between two points.
        """
        #if self < other: #commented because actually, no one cares if fct is symetric
            #return other.distance_carre_to(self)  # we are now a symmetric function
        ...
        return total#maybe optimize that w/ comparing distances²
    ...
    def distance_to(self, other):
        ...
        return sqrt(total)#maybe optimize that w/ comparing distances²
